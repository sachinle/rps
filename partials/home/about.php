        ...
        <div class="flex flex-col gap-10 lg:grid lg:grid-cols-12 lg:items-center lg:gap-14">
            ...
            <div class="col-span-12 lg:col-span-7">
                ...
                <div class="reveal-up mt-8 flex flex-wrap gap-4">
                    ...
                    <a href="#admission" class="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-rps-pink to-rps-amber px-5 py-3 text-sm font-semibold text-white transition hover:scale-105">
                        Book a Visit
                    </a>
                </div>
            </div>
