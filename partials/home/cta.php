<?php
    // CTA — full-width "Empower Minds, Shape Futures" admissions band.
?>
        ...
        <div class="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-rps-navy via-rps-blue/60 to-rps-ink p-10 md:p-14">
            ...
            <div class="relative flex flex-col items-center gap-6 text-center md:flex-row md:justify-between md:text-left">
                ...
                <div class="flex flex-wrap items-center justify-center gap-3 md:flex-nowrap md:shrink-0 reveal-up">
                    ...
                    <a href="tel:+918144260260" class="inline-flex items-center gap-2 rounded-2xl border border-white/20 bg-white/10 px-7 py-4 font-semibold text-white backdrop-blur transition hover:bg-white/15">
                        Call Us
                    </a>
                </div>
            </div>
