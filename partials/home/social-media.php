...
<section class="relative py-24 sec-light">
    <div class="rps-container">
        <div class="flex flex-col items-center gap-6 md:flex-row md:items-end md:justify-between">
            ...
            <a href="https://www.instagram.com/" target="_blank" rel="noopener" class="reveal-up inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-rps-pink to-rps-amber px-5 py-2.5 text-sm font-semibold text-white transition hover:scale-105">
                Follow @rps
